...
test('Edit Units submit button click calls SET function',()=>{
    ...
    expect(firestore().collection().doc().set).toHaveBeenCalledWith({Codex: "Transformers",Name: 'Bee',Cost: 100,Abilities:'Jump',Gear: ["Axe"]})
});
test('Edit Units handleNameInput function works properly',()=>{
    ...
    expect(mockSetState).toHaveBeenCalledWith({isLoading:false,Unit:{Codex: "Transformers",Name: 'Megatron',Cost: 100,Abilities:'Jump',Gear: ["Axe"]}});
});
test('Edit Units handleCostInput function works properly',()=>{
    ...
    expect(mockSetState).toHaveBeenCalledWith({isLoading:false,Unit:{Codex: "Transformers",Name: 'Bee',Cost: 70,Abilities:'Jump',Gear: ["Axe"]}});
});
test('Edit Units handleAbilitiesInput function works properly',()=>{
    ...
    expect(mockSetState).toHaveBeenCalledWith({isLoading:false,Unit:{Codex: "Transformers",Name: 'Bee',Cost: 100,Abilities:'Dive',Gear: ["Axe"]}});
});
test('Edit Units Rem-Equipment Button works properly',()=>{
    ...
    expect(mockSetState).toHaveBeenCalledWith({isLoading:false,Unit:{Codex: "Transformers",Name: 'Bee',Cost: 100,Abilities:'Jump',Gear: []}});
});
